...
<SelectButton icon={TbRubberStamp} selected={issuanceMode} onClick={handlePortalModeChange} >
Issue
</SelectButton>
<SelectButton icon={ViewfinderCircleIcon} selected={verificationMode} onClick={handlePortalModeChange} >
Verify
</SelectButton>
</div>
</div>
