...
<nav className="flex gap-4 mt-4">
  <Link href="/onboarding/onboard-issuer" className="text-blue-600 underline">
    Onboard Issuer
  </Link>
  <Link href="/onboarding/trusted-issuers" className="text-blue-600 underline">
    Trusted Issuers
  </Link>
</nav>
...
export default function Home() {
  ...
  return (
    <div>
      ...
      <main className="flex flex-col items-center gap-5 justify-between mt-16 w-full px-4">
        <div className="flex flex-row gap-5 w-full max-w-7xl px-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-10 gap-x-8 mt-10 w-full max-w-7xl mx-auto">
